...
app.get('/api/catechism_answers', (req, res) => {
  const catechism_answers = [
    {id: 0,
    ...
    {id: 47,
    question: "What are specially taught by these words [before me] in the first commandment?",
